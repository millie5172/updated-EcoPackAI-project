...
# Call init_db at startup (works with gunicorn too)
init_db()
...
MATERIALS_DB = [
    {"name": "Bagasse Fiber", "co2_per_kg": 0.15, "cost_per_unit": 0.42, "biodegradability": 98, "durability": 85, "recyclability": 100},
    {"name": "Mushroom Mycelium", "co2_per_kg": 0.08, "cost_per_unit": 0.85, "biodegradability": 100, "durability": 90, "recyclability": 100},
    {"name": "PLA Bioplastic", "co2_per_kg": 0.68, "cost_per_unit": 0.65, "biodegradability": 85, "durability": 75, "recyclability": 60},
    {"name": "Recycled Cardboard", "co2_per_kg": 0.32, "cost_per_unit": 0.35, "biodegradability": 95, "durability": 70, "recyclability": 95},
    {"name": "Recycled Paperboard", "co2_per_kg": 0.30, "cost_per_unit": 0.40, "biodegradability": 90, "durability": 65, "recyclability": 90},
    {"name": "Corn Starch Polymer", "co2_per_kg": 0.45, "cost_per_unit": 0.58, "biodegradability": 90, "durability": 72, "recyclability": 70},
    {"name": "Biodegradable Plastic", "co2_per_kg": 0.55, "cost_per_unit": 0.70, "biodegradability": 80, "durability": 78, "recyclability": 50},
    {"name": "Glass", "co2_per_kg": 0.85, "cost_per_unit": 0.90, "biodegradability": 0, "durability": 95, "recyclability": 100},
    {"name": "Aluminum", "co2_per_kg": 1.20, "cost_per_unit": 1.10, "biodegradability": 0, "durability": 98, "recyclability": 100},
    {"name": "Molded Pulp", "co2_per_kg": 0.25, "cost_per_unit": 0.45, "biodegradability": 95, "durability": 68, "recyclability": 85}
]
...
def recommend_material():
    ...
    for m in MATERIALS_DB:
        score = calculate_environment_score(m["co2_per_kg"], m["recyclability"], m["durability"])
        results.append({"material": m["name"], "environment_score": score, "co2": m["co2_per_kg"], "cost": m["cost_per_unit"]})
...
def dashboard():
    try:
        with closing(sqlite3.connect(DB_PATH)) as conn:
            ...
            html = f"""
            <html><head><title>EcoPackAI Dashboard</title>
            <style>
            ...
            <body>
                ...
                <div style="margin: 20px 0;">
                    <div class="metric"><div>CO₂ Reduction Potential</div><div class="value">{co2_reduction}%</div></div>
                    <div class="metric"><div>Cost Savings Potential</div><div class="value">{cost_savings}%</div></div>
                    <div class="metric"><div>Total Predictions</div><div class="value">{len(df)}</div></div>
                </div>
